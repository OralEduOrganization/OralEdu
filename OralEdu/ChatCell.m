...
-(void)getCellHeight{
    ...
    self.height = self.textView.bounds.size.height + 20*self.frame.size.height;
}
...
-(UILabel *)textChatLabel{
    ...
    if (!_textChatLabel) {
        ...
        [_textChatLabel setFont:[UIFont fontWithName:@"Helvetica-Bold" size:30*self.frame.size.width]];
